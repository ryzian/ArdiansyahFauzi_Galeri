  ...
  <div class="row">
    ...
    <div class="card">
        ...
        <div class="card-footer text-center">
            <a href="ardi_prosses_like.php?fotoid=<?php echo $fotoid; ?>">
            ...
            <a href="#" onclick="printImage('assets/img/<?php echo htmlspecialchars($ardi_data['tempatfile']); ?>')" class="text-success">
...
<form action="ardi_proses_komentar.php" method="POST">
...
function printImage(imgSrc) {
    ...
    printWindow.document.write('<img src="' + imgSrc + '" style="width:100%; max-width:800px;">');
